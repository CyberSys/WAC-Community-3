...
ENT.WheelInfo={
	{
		...
		pos=Vector(2.34,-30,-42),
		friction=100,
		mass=200,
	},
	{
		mdl="models/drmatt/rah66/frontwheel2.mdl",
		pos=Vector(2.34,26,-42),
		friction=100,
		mass=200,
	},
	{
...
function ENT:AddStuff()
	...
	e1:SetModel("models/drmatt/rah66/gunmount.mdl")
	e1:SetPos(self:LocalToWorld(Vector(112,0,-33)))
	e1:SetAngles(ang)
	e1:Spawn()
	e1:Activate()
	...
	e2:SetPos(self:LocalToWorld(Vector(112,0,-40)))
	e2:SetAngles(ang)
	e2:Spawn()
	e2:Activate()
	...
	e4:SetPos(self:LocalToWorld(Vector(90,0,-40)))
	...
	e5:SetPos(self:LocalToWorld(Vector(90,0,-50)))
